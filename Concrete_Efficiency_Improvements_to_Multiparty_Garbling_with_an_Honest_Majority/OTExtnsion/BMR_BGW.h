...
void addLocalShares();//int sizeOfShares
...
void computeSharesLatinCrypt(int party, __m128i* shares);

void computeSharesLatinCryptLocal(__m128i* shares);

//compute shares of multiplications of R with the correct lambdas, convert to additive shares, and add to shares of PRG+S
